...
public:
	...
	float renderingInconsolataFonts(char c, glm::vec2 offset, std::vector<Geometry> &objects);
	float renderingGreatVibeFonts(char c, glm::vec2 offset, std::vector<Geometry> &objects);
	...
	float setInconsolataText(std::string s, std::vector<Geometry> &objects);
	float setGreatVibeText(std::string s, std::vector<Geometry> &objects);
